<div align="center">
  ...
  <p align="center">
    <img src="https://img.shields.io/badge/version-1.1.42-blue" alt="version">
...
│   ├── sessionRepo/  # 会话持久化
│   ├── tools/        # 工具实现（一个工具一个文件，按分类目录组织）
│   │   ├── file/          # 文件操作（读、写、编辑、删除、复制/移动、列表、信息、建目录）
│   │   ├── search/        # 文件名与内容搜索
│   │   ├── execute/       # 命令/脚本执行（含审批与风险分类）
│   │   ├── knowledge-base/# 知识库工具
│   │   ├── web/           # 网络搜索与网页抓取
│   │   ├── vision/        # 视觉分析工具
│   │   ├── skill/         # 技能管理工具
│   │   ├── system/        # 系统工具（时间、用户选择）
│   │   └── output-store.ts# 跨层工具输出流（UI / services）
│   └── vision/       # 视觉服务实现
│
